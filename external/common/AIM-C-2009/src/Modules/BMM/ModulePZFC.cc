 ...
 *  \version \$Id: ModulePZFC.cc 173 2010-11-04 19:48:53Z tom@acousticscale.org $
 */
...
ModulePZFC::ModulePZFC(Parameters *parameters) : Module(parameters) {
  ...
  module_version_ = "$Id: ModulePZFC.cc 173 2010-11-04 19:48:53Z tom@acousticscale.org $";
