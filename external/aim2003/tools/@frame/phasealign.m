...
if isfield(options,'do_phase_alignment')%
	do_phase_alignment=options.do_phase_alignment;
else
	do_phase_alignment='nr_cycles';
end

if isfield(options,'phase_alignment_nr_cycles')
	phase_alignment_nr_cycles=options.phase_alignment_nr_cycles;
else
	phase_alignment_nr_cycles=3;
end
...
if strcmp(options.do_phase_alignment,'nr_cycles')
	for ii=1:nr_chan
		shift=phase_alignment_nr_cycles/cfs(ii);
