...
for i=3:nr_files
	...
	if ~strcmp(lower(current_column_name),'cvs') % we dont want the version control info. Could still be there because I usually forget about it
		...
		if ~strcmp(current_column_name,'signal')
			...
			for j=3:nr_modules
            	...
            	if ~strcmp(lower(current_module_name),'cvs') % we dont want the version control info. Could still be there because I usually forget about it
