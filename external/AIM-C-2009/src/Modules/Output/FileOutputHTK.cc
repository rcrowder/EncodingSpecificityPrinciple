 ...
 * \version \$Id: FileOutputHTK.cc 175 2010-11-07 07:38:20Z tom@acousticscale.org $
 */
...
FileOutputHTK::FileOutputHTK(Parameters *params) : Module(params) {
  ...
  module_type_ = "output";
  module_version_ = "$Id: FileOutputHTK.cc 175 2010-11-07 07:38:20Z tom@acousticscale.org $";
